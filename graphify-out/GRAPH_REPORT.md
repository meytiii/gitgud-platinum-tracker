...
- **Why does `GitGud Tracker` connect `Project Docs & Features` to `Dark Souls Series`, `Bloodborne & Lies of P`, `Elden Ring Universe`, `Demon's Souls`, `Sekiro`?**
  _High betweenness centrality (0.247) - this node is a cross-community bridge._
- **Why does `Game Selector Sidebar UI` connect `Bloodborne & Lies of P` to `Dark Souls Series`, `Project Docs & Features`, `Elden Ring Universe`, `Demon's Souls`, `Sekiro`?**
  _High betweenness centrality (0.172) - this node is a cross-community bridge._
- **Why does `Bloodborne` connect `Bloodborne & Lies of P` to `Project Docs & Features`?**
